  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const SizedBox(height: 10),
        LotteryWheel(
          maxSize: MediaQuery.of(context).size.width * 0.85,
          items: [
            LotteryItem(name: "+2积分", color: Colors.red, icon: Icons.sentiment_satisfied, probability: 10),
            LotteryItem(name: "+1积分", color: Colors.orange, icon: Icons.sentiment_satisfied_outlined, probability: 50),
            LotteryItem(name: "+5积分", color: Colors.cyan, icon: Icons.diamond, probability: 7),
            LotteryItem(name: "+10积分", color: Colors.green, icon: Icons.emoji_events, probability: 2.89),
            LotteryItem(name: "+100积分", color: Colors.pink, icon: Icons.savings, probability: 0.1),
